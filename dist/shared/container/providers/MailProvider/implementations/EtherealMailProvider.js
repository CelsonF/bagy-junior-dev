...
var EtherealMailProvider = /** @class */ (function () {
    ...
    EtherealMailProvider.prototype.createAccount = function () {
        return __awaiter(this, void 0, void 0, function () {
            var account, transporter;
    ...
    EtherealMailProvider.prototype.sendEmail = function (to, body, subject) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.createAccount()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.client.sendMail({
                                from: 'Bagy <bagy@bagy.com.br.com>',
                                to: to,
                                subject: subject,
                                text: body,
                            })];
